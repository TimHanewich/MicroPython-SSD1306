...
if sys.platform == "rp2":
    ...
    class Typewriter:
        ...
        def __init__(self) -> None:
            ...
            self.characters.append(("0", BitGraphic(jsond={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("1", BitGraphic(jsond={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("2", BitGraphic(jsond={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("3", BitGraphic(jsond={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("4", BitGraphic(jsond={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("5", BitGraphic(jsond={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("6", BitGraphic(jsond={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("7", BitGraphic(jsond={"bits": "", "width": 16, "height": 16})))
