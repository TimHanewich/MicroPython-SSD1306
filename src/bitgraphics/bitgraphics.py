...
if sys.platform == "rp2":
    ...
    class Typewriter:
        ...
        def __init__(self) -> None:
            ...
            self.characters.append(("0", BitGraphic(jsons={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("1", BitGraphic(jsons={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("2", BitGraphic(jsons={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("3", BitGraphic(jsons={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("4", BitGraphic(jsons={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("5", BitGraphic(jsons={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("6", BitGraphic(jsons={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("7", BitGraphic(jsons={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("8", BitGraphic(jsons={"bits": "", "width": 16, "height": 16})))
            self.characters.append(("9", BitGraphic(jsons={"bits": "", "width": 16, "height": 16})))
